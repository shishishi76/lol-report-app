...
export const metadata: Metadata = { title: "プレイヤー検索" };
    ...
    <main className="relative min-h-screen overflow-hidden bg-[#071019] px-5 py-8 text-[#f4f1e8] sm:px-8 lg:px-12">
      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        <section className="mx-auto max-w-2xl py-20 sm:py-28">
          <p className="text-xs font-semibold tracking-[0.25em] text-[#3fb6c5] uppercase">Player lookup</p>
          <h1 className="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl">プレイヤーを検索</h1>
          <p className="mt-5 max-w-xl text-sm leading-7 text-slate-400">
            Riot IDのゲーム名とタグラインを入力してください。ログイン中のAccess Tokenを使ってAPIへ安全に接続します。
          </p>
          <div className="mt-10">
            <PlayerSearch />
          </div>
